...
export const Musical_hearings = () => {
    const[imageNumber,setimageNumber]=useState(0);
  return (
    <div className='Musical_hearings'>
        <div className="header" dir='rtl'>
        <p>  فقرة </p>

			<button className="btn" type="button">
				<strong>مسامع موسيقية</strong>
        ...
        <div className='body' onClick={()=>{if(imageNumber<6){setimageNumber(pre=>pre+1)}}}>
